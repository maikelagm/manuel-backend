...
from app.services.db_tests_service import db_test_service
...
async def get_security_tests():
    ...
    tests_list = "<ul>"
    for test_name in db_test_service.available_tests:
...
async def run_security_test(test_name: str, password: str):
    ...
    """
    try:
        result, execution_info = db_test_service.run_test(test_name, password)
